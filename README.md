...
P0RRUM.exe (For Entertainment and Educational Purposes Only)

P0RRUM is an open-source application built to simulate digital display anomalies and real-time screen glitch art. This repository provides both the visual framework and a pre-compiled demonstration interface.
...
Ensure that your asset files (xbutton.png and background.mp3) are placed in the same folder as the P0RRUM.exe.
